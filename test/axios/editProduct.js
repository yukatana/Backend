...
const TEST_UPDATE_PRODUCT_ID = '63968c2faee07514abf5de56' // Manually change this to test product ID
...
const editProduct = async () => {
    ...
    const response = await axiosClient.put(`${BASE_URL}/api/products/${TEST_UPDATE_PRODUCT_ID}`, update)
    logger.info(response.data)
}

createSession().then(editProduct)